...
- As a Snow Equipment Renter, I want to be able to know the location of the lender so that I know that it isn't too far.
- As a Snow Equipment Renter, I want to know whether the lender can deliver the equipment or not, so that I can decide if I want to go through with the rent.
- As a Snow Equipment Renter, I want to have access to customer support so that I am protected in case the equipment breaks.
- As a Snow Equipment Renter, I want to see reviews of the equipment so that I know that it is reliable.
